...
## Changed Versions
 ...
 @react-navigation/bottom-tabs    ^5.11.2  →   ^6.3.3
 @react-navigation/drawer         ^5.11.4  →   ^6.4.4
 @react-navigation/native         ^5.8.10  →  ^6.0.12
 @react-navigation/stack          ^5.12.8  →   ^6.2.3
 @reduxjs/toolkit                  ^1.5.1  →   ^1.8.5
 axios                            ^0.24.0  →  ^0.27.2
 expo                             ^44.0.0  →  ^46.0.9
 expo-asset                        ~8.4.5  →   ~8.6.1
 expo-cli                         ^4.13.0  →   ^6.0.5
 expo-font                        ~10.0.4  →  ~10.2.0
 expo-updates                     ~0.11.6  →  ~0.14.5
 jest                             ^26.6.3  →  ^29.0.1
 moment                           ^2.29.2  →  ^2.29.4
 prop-types                       ^15.7.2  →  ^15.8.1
 react                             17.0.1  →   18.2.0
 react-dom                         17.0.1  →   18.2.0
 react-native                      0.64.3  →   0.69.5
 react-native-gesture-handler      ~2.1.0  →   ~2.6.0
 react-native-reanimated           ~2.3.1  →  ~2.10.0
 react-native-safe-area-context     3.3.2  →    4.3.3
 react-native-screens             ~3.10.1  →  ~3.17.0
 react-native-svg                  12.1.1  →   13.1.0
 react-native-svg-transformer     ^0.14.3  →   ^1.0.0
 react-native-vector-icons         ^6.6.0  →   ^9.2.0
 react-native-web                  0.17.1  →   0.18.8
 react-redux                       ^7.1.1  →   ^8.0.2
 redux                             ^4.0.4  →   ^4.2.0
 babel-plugin-module-resolver      ^4.0.0  →   ^4.1.0
 babel-preset-expo                  9.0.1  →    9.2.0
 braces                           >=2.3.1  →  >=3.0.2
 eslint                            ^6.8.0  →  ^8.23.0
 eslint-config-airbnb             ^18.1.0  →  ^19.0.4
 eslint-config-prettier           ^6.11.0  →   ^8.5.0
 eslint-plugin-import             ^2.20.2  →  ^2.26.0
 eslint-plugin-jsx-a11y            ^6.2.3  →   ^6.6.1
 eslint-plugin-prettier            ^3.1.3  →   ^4.2.1
 eslint-plugin-react              ^7.19.0  →  ^7.31.1
 eslint-plugin-react-hooks         ^2.5.1  →   ^4.6.0
 husky                             ^4.2.5  →   ^8.0.1
 jest-expo                        ^44.0.0  →  ^46.0.1
 lint-staged                      ^10.2.0  →  ^13.0.3
 prettier                          ^2.0.5  →   ^2.7.1
 pretty-quick                      ^2.0.1  →   ^3.1.3
 react-test-renderer             ^16.13.1  →  ^18.2.0
